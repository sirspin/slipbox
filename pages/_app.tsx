...
// Loading bar on client-side navigation
  ...
  return (
    <ThemeProvider attribute="class" enableSystem={true}>
      <div className="flex md:flex-row flex-col h-screen">
        ...
        <div className="block sm:hidden text-left px-6 mt-auto dark:bg-neutral-600 bg-neutral-200">
          <div className="text-sm py-2 dark:text-neutral-200 text-neutral-600 flex items-center">
            <img className="h-4 w-4" src={MarkbaseFavicon.src} />
            <span className="ml-2">
              Made with{" "}
              <a
      ...
      <div className="hidden sm:block sm:fixed sm:top-5 sm:right-5">
        <a
          href="https://markbase.xyz"
          className="rounded-md text-xs font-medium bg-black dark:bg-gray-100 dark:text-gray-800 text-white w-fit flex items-center opacity-80 hover:opacity-100 cursor-pointer shadow-lg"
        >
          <img className="h-5 w-5" src={MarkbaseFavicon.src} />
        </a>
      </div>
      <div className="hidden sm:block sm:fixed sm:bottom-5 sm:left-5">
        ...
        <div className="sticky top-0 z-10 flex-shrink-0 flex">
          <div className="flex-1 px-2 flex">
            <div className="flex-1 flex">
              ...
              <div className="h-fit w-full md:w-2/3 max-w-md text-gray-600 focus-within:text-gray-800 dark:text-gray-400 dark:focus-within:text-gray-400">
                {/* <div className="absolute inset-y-0 left-0 flex items-center pointer-events-none pr-4">
                      <SearchIcon className="h-5 w-5" aria-hidden="true" />
                    </div> */}
                <input
                  id="search-field"
                  className=" block w-full pl-3 pr-6 border-transparent text-gray-600 focus:placeholder-gray-500 placeholder-gray-500 dark:text-gray-400 dark:placeholder-gray-500 focus:outline-none dark:focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm rounded-md text-left"
                  placeholder="Search"
                  type="search"
                  name="search"
                  value={searchQuery}
